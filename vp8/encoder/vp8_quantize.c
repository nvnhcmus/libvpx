...
void vp8_fast_quantize_b_c(BLOCK *b, BLOCKD *d)
{
    ...
    *d->eob = (char)(eob + 1);
	...
	//fprintf(stdout, "nvnhcmus_cus: vp8_fast_quantize_b_c\n");
}
...
void vp8_regular_quantize_b_c(BLOCK *b, BLOCKD *d)
{
    ...
    *d->eob = (char)(eob + 1);
	//fprintf(stdout, "nvnhcmus_cus: vp8_regular_quantize_b_c\n");
}
...
void vp8_quantize_mby(MACROBLOCK *x)
{
	...
	//fprintf(stdout, "nvnhcmus_cus: vp8_quantize_mby\n");
}
...
void vp8_quantize_mb(MACROBLOCK *x)
{
    ...
    for (i = 0; i < 24+has_2nd_order; i++)
        x->quantize_b(&x->block[i], &x->e_mbd.block[i]);
	//fprintf(stdout, "nvnhcmus_cus: vp8_quantize_mb\n");
}
...
void vp8_quantize_mbuv(MACROBLOCK *x)
{
    ...
    for (i = 16; i < 24; i++)
        x->quantize_b(&x->block[i], &x->e_mbd.block[i]);
	//fprintf(stdout, "nvnhcmus_cus: vp8_quantize_mbuv\n");
}
                         ...
                         short *shift, short d)
{
	...
	//fprintf(stdout, "nvnhcmus_cus: invert_quant\n");
}
...
void vp8_update_zbin_extra(VP8_COMP *cpi, MACROBLOCK *x)
{
    ...
    zbin_extra = ZBIN_EXTRA_Y2;
    x->block[24].zbin_extra = (short)zbin_extra;
	//fprintf(stdout, "nvnhcmus_cus: vp8_update_zbin_extra\n");
}
#undef ZBIN_EXTRA_Y
#undef ZBIN_EXTRA_UV
#undef ZBIN_EXTRA_Y2
