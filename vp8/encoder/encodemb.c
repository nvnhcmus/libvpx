...
void vp8_subtract_mby(short *diff, unsigned char *src, int src_stride,
	...
	//fprintf(stdout, "nvhmcus: vp8_subtract_block	START\n");
...
static void optimize_mb(MACROBLOCK *x)
{
	...
	fprintf(stdout, "nvnhcmus_cus: optimize_mb\n");
}
...
void vp8_optimize_mby(MACROBLOCK *x)
{
	...
	//fprintf(stdout, "nvnhcmus_cus: vp8_optimize_mbuy\n");
}
...
void vp8_optimize_mbuv(MACROBLOCK *x)
{
	...
	//fprintf(stdout, "nvnhcmus_cus: vp8_optimize_mbuv\n");
}


//static int macroblockCount = 0;//nvnhcmus
...
void vp8_encode_inter16x16(MACROBLOCK *x)
{
	...
	//fprintf(stdout, "nvhmcus: vp8_subtract_mb	START\n");
    vp8_subtract_mb(x);
	//fprintf(stdout, "nvhmcus: vp8_subtract_mb	END\n");
	...
	if (x->optimize) {
		//fprintf(stdout, "nvnhcmus_cus: vp8_encode_inter16x16: optimize_mb\n");
		optimize_mb(x);
	}
	...
	//macroblockCount++;
	//fprintf(stdout, "nvnhcmus_cus: vp8_encode_inter16x16: %d: %d(ms)\n", 
	//	macroblockCount,
...
void vp8_encode_inter16x16y(MACROBLOCK *x)
{
	...
	//fprintf(stdout, "nvnhcmus_cus: vp8_encode_inter16x16y\n");
}
