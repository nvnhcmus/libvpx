...
// Specific configuration for Intel core
#define HAVE_MMX		1
#define HAVE_SSE		1
#define HAVE_SSE2		1
#define HAVE_SSE3		1
...
#define CONFIG_MULTITHREAD 1//NHUONG
...
// Nhuong Nguyen (2016/06/09)
// Configuration to reduce the size of static lib vpx
...
#define CONFIG_ONTHEFLY_BITPACKING 1//nhuong
